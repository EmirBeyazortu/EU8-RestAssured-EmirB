...
public class ORDSApiWithJsonPath extends HRTestBase {
    ...
    public void test2(){
        ...
        List<String> employeeNamesMoreThan10000 = jsonPath.getList("items.findAll {it.salary>10000}.first_name");
        System.out.println("employeeNamesMoreThan10000 = " + employeeNamesMoreThan10000);
